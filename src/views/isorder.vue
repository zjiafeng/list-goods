	...
	export default {
		...
		methods: {
			...
			emit(i) {
				...
				this.isemit = true;
				this.isshow = true;
				this.address.receiverName = this.isaddress[i].receiverName
				this.address.selected.push(this.isaddress[i].receiverProvince);
				this.address.selected.push(this.isaddress[i].receiverCity);
				this.address.receiverMobile = this.isaddress[i].receiverMobile;
				this.address.receiverAddress = this.isaddress[i].receiverAddress;
				this.address.receiverZip = this.isaddress[i].receiverZip;
			},
			//删除收件人信息
			isdel(i) {
				let postData = this.$qs.stringify({
